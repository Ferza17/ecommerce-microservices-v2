...
#[derive(
    utoipa::ToSchema, serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message,
)]
...
#[derive(
    utoipa::ToSchema, serde::Serialize, serde::Deserialize, Clone, Copy, PartialEq, ::prost::Message,
)]
...
pub struct CreateShippingResponse {
    ...
    #[prost(message, optional, tag = "3")]
    pub data: ::core::option::Option<create_shipping_response::CreateShippingResponseData>,
}
...
pub struct UpdateShippingResponse {
    ...
    pub status: ::prost::alloc::string::String,
    #[prost(message, optional, tag = "3")]
    pub data: ::core::option::Option<update_shipping_response::UpdateShippingResponseData>,
}
...
pub struct DeleteShippingResponse {
    ...
    pub status: ::prost::alloc::string::String,
    #[prost(message, optional, tag = "3")]
    pub data: ::core::option::Option<delete_shipping_response::DeleteShippingResponseData>,
}
...
pub struct ListShippingProvidersResponse {
    ...
    #[prost(message, optional, tag = "3")]
    pub data:
        ::core::option::Option<list_shipping_providers_response::ListShippingProvidersResponseData>,
}
...
pub mod shipping_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::CreateShippingResponse>, tonic::Status>
        {
            ...
            let path =
                http::uri::PathAndQuery::from_static("/shipping.ShippingService/CreateShipping");
        ...
        ) -> std::result::Result<tonic::Response<super::GetShippingByIdResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/shipping.ShippingService/GetShippingById");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "shipping.ShippingService",
                "GetShippingById",
        ...
        ) -> std::result::Result<tonic::Response<super::ListShippingResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::UpdateShippingResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/shipping.ShippingService/UpdateShipping");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "shipping.ShippingService",
                "UpdateShipping",
        ...
        ) -> std::result::Result<tonic::Response<super::DeleteShippingResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/shipping.ShippingService/DeleteShipping");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "shipping.ShippingService",
                "DeleteShipping",
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        where
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::BoxBody>>>::Error:
                Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ShippingProviderServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        ) -> std::result::Result<tonic::Response<super::ListShippingProvidersResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/shipping.ShippingService/CreateShipping" => {
                        ...
                        for CreateShippingSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ShippingService>::create_shipping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/shipping.ShippingService/GetShippingById" => {
                        ...
                        for GetShippingByIdSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ShippingService>::get_shipping_by_id(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/shipping.ShippingService/ListShipping" => {
                    ...
                    impl<T: ShippingService> tonic::server::UnaryService<super::ListShippingRequest>
                ...
                "/shipping.ShippingService/UpdateShipping" => {
                        ...
                        for UpdateShippingSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ShippingService>::update_shipping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/shipping.ShippingService/DeleteShipping" => {
                        ...
                        for DeleteShippingSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ShippingService>::delete_shipping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod shipping_provider_service_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ShippingProviderServiceServer<T>
    where
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/shipping.ShippingProviderService/GetShippingProviderById" => {
                    #[allow(non_camel_case_types)]
                    struct GetShippingProviderByIdSvc<T: ShippingProviderService>(pub Arc<T>);
                    impl<T: ShippingProviderService>
                ...
                "/shipping.ShippingProviderService/ListShippingProviders" => {
                    #[allow(non_camel_case_types)]
                    struct ListShippingProvidersSvc<T: ShippingProviderService>(pub Arc<T>);
                    impl<T: ShippingProviderService>
