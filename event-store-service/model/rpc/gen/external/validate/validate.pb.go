...
const file_external_validate_validate_proto_rawDesc = "" +
	"\n" +
	" external/validate/validate.proto\x12\bvalidate\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc8\b\n" +
	"\n" +
	"FieldRules\x120\n" +
	...
	"\x05rules\x12\x1d.google.protobuf.FieldOptions\x18\xaf\b \x01(\v2\x14.validate.FieldRulesR\x05rulesB_\n" +
	"\fcom.validateB\rValidateProtoH\x02P\x01\xa2\x02\x03VXX\xaa\x02\bValidate\xca\x02\bValidate\xe2\x02\x14Validate\\GPBMetadata\xea\x02\bValidate"

var (
	file_external_validate_validate_proto_rawDescOnce sync.Once
	file_external_validate_validate_proto_rawDescData []byte
)

func file_external_validate_validate_proto_rawDescGZIP() []byte {
	file_external_validate_validate_proto_rawDescOnce.Do(func() {
		file_external_validate_validate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_validate_validate_proto_rawDesc), len(file_external_validate_validate_proto_rawDesc)))
	})
...
var file_external_validate_validate_proto_goTypes = []any{
...
func file_external_validate_validate_proto_init() {
	...
	file_external_validate_validate_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_external_validate_validate_proto_msgTypes[14].OneofWrappers = []any{
	...
	file_external_validate_validate_proto_msgTypes[15].OneofWrappers = []any{
		(*BytesRules_Ip)(nil),
		(*BytesRules_Ipv4)(nil),
		(*BytesRules_Ipv6)(nil),
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_validate_validate_proto_rawDesc), len(file_external_validate_validate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   23,
			NumExtensions: 4,
			NumServices:   0,
