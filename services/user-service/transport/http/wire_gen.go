...
func Provide() *Transport {
	...
	iEventUseCase := usecase2.NewEventUseCase(iEventMongoRepository, iKafkaInfrastructure, iTelemetryInfrastructure)
	...
	authPresenter := presenter.NewAuthPresenter(iAuthUseCase, iUserUseCase, iTelemetryInfrastructure, iZapLogger)
