...
## Production
curl --request PUT --data 'local' http://localhost:8500/v1/kv/production/services/notification/ENV
...
## Production
curl --request PUT --data 'local' http://localhost:8500/v1/kv/production/services/product/ENV
