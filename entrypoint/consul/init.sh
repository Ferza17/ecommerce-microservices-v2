...
##########################################################################################################################################################################################################################
sh ./rabbitmq/kv_register.sh
sh ./rabbitmq/kv_register_exchange.sh
sh ./rabbitmq/kv_register_queue.sh
sh ./rabbitmq/service_register.sh

# LOAD CONFIG KAFKA
##########################################################################################################################################################################################################################
sh ./kafka/kv_register_broker.sh
