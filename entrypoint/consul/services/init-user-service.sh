...
initialize_user_service(){
  ...
  curl --request PUT --data 'localhost' http://localhost:8500/v1/kv/local/services/user/HTTP_HOST
  curl --request PUT --data '40056' http://localhost:8500/v1/kv/local/services/user/HTTP_PORT
  ...
  curl --request PUT --data 'user-service' http://localhost:8500/v1/kv/production/services/user/HTTP_HOST
  curl --request PUT --data '40056' http://localhost:8500/v1/kv/production/services/user/HTTP_PORT
  ...
  curl --request PUT --data 'http://user-service:4000?access_token=%s?refresh_token=?' http://localhost:8500/v1/kv/production/services/user/VERIFICATION_USER_LOGIN_URL
