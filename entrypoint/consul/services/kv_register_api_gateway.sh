...
## Production
consul kv put production/services/api-gateway/ENV 'production'
consul kv put production/services/api-gateway/SERVICE_NAME 'api-gateway-service'
consul kv put production/services/api-gateway/HTTP_HOST '0.0.0.0'
consul kv put production/services/api-gateway/HTTP_PORT '4000'
consul kv put production/services/api-gateway/METRIC_HTTP_PORT '40001'
