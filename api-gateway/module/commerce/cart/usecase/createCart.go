...
func (u *CartUseCase) CreateCart(ctx context.Context, requestId string, req *commerceRpc.CreateCartItemRequest) (*commerceRpc.CreateCartItemResponse, error) {
	var (
		err        error = nil
	...
	return &commerceRpc.CreateCartItemResponse{}, nil
}
