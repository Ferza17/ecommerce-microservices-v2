...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let proto_files = &[
        ...
        "proto/v1/product/request.proto",
        "proto/v1/product/response.proto",
        "proto/v1/product/model.proto",
        // PAYMENT
    ...
    config
        ...
        // Add #[serde(default)] for repeated request fields
        .field_attribute("ids", "#[serde(default)]")
        .field_attribute("names", "#[serde(default)]")
