...
export const UserServiceService = {
  findUserById: {
    path: "/proto.UserService/FindUserById",
    requestStream: false,
  ...
  findUserByEmailAndPassword: {
    path: "/proto.UserService/FindUserByEmailAndPassword",
    requestStream: false,
    responseStream: false,
...
export const UserServiceClient = makeGenericClientConstructor(UserServiceService, "proto.UserService") as unknown as {
