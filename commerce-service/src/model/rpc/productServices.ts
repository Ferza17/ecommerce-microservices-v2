...
export const ProductServiceService = {
  findProductsWithPagination: {
    path: "/proto.ProductService/FindProductsWithPagination",
    requestStream: false,
  ...
  findProductById: {
    path: "/proto.ProductService/FindProductById",
    requestStream: false,
    responseStream: false,
  ...
  createProduct: {
    path: "/proto.ProductService/CreateProduct",
    requestStream: false,
    responseStream: false,
  ...
  updateProductById: {
    path: "/proto.ProductService/UpdateProductById",
    requestStream: false,
    responseStream: false,
  ...
  deleteProductById: {
    path: "/proto.ProductService/DeleteProductById",
    requestStream: false,
    responseStream: false,
