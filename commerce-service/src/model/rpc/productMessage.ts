...
export interface FindProductsWithPaginationResponse_ProductsEntry {
  key: string;
...
function createBaseFindProductsWithPaginationResponse(): FindProductsWithPaginationResponse {
  return { products: {}, limit: 0, page: 0 };
}
...
export const FindProductsWithPaginationResponse: MessageFns<FindProductsWithPaginationResponse> = {
  encode(message: FindProductsWithPaginationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    Object.entries(message.products).forEach(([key, value]) => {
      FindProductsWithPaginationResponse_ProductsEntry.encode({ key: key as any, value }, writer.uint32(10).fork())
        .join();
    });
    if (message.limit !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = FindProductsWithPaginationResponse_ProductsEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): FindProductsWithPaginationResponse {
    return {
      products: isObject(object.products)
        ? Object.entries(object.products).reduce<{ [key: string]: Product }>((acc, [key, value]) => {
  ...
  fromPartial(object: DeepPartial<FindProductsWithPaginationResponse>): FindProductsWithPaginationResponse {
    const message = createBaseFindProductsWithPaginationResponse();
    message.products = Object.entries(object.products ?? {}).reduce<{ [key: string]: Product }>((acc, [key, value]) => {
      if (value !== undefined) {
...
function createBaseFindProductsWithPaginationResponse_ProductsEntry(): FindProductsWithPaginationResponse_ProductsEntry {
  return { key: "", value: undefined };
}

export const FindProductsWithPaginationResponse_ProductsEntry: MessageFns<
  FindProductsWithPaginationResponse_ProductsEntry
> = {
  encode(
    message: FindProductsWithPaginationResponse_ProductsEntry,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FindProductsWithPaginationResponse_ProductsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFindProductsWithPaginationResponse_ProductsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): FindProductsWithPaginationResponse_ProductsEntry {
    return {
  ...
  toJSON(message: FindProductsWithPaginationResponse_ProductsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(
    base?: DeepPartial<FindProductsWithPaginationResponse_ProductsEntry>,
  ): FindProductsWithPaginationResponse_ProductsEntry {
    return FindProductsWithPaginationResponse_ProductsEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<FindProductsWithPaginationResponse_ProductsEntry>,
  ): FindProductsWithPaginationResponse_ProductsEntry {
    const message = createBaseFindProductsWithPaginationResponse_ProductsEntry();
