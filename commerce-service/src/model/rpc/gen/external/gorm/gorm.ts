...
//   protoc               unknown
// source: external/gorm/gorm.proto
...
export const GormFileOptions: MessageFns<GormFileOptions> = {
  encode(_: GormFileOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GormFileOptions {
  ...
  create(base?: DeepPartial<GormFileOptions>): GormFileOptions {
    return GormFileOptions.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<GormFileOptions>): GormFileOptions {
    const message = createBaseGormFileOptions();
    return message;
  },
};
...
function createBaseGormMessageOptions(): GormMessageOptions {
  return { ormable: false, include: [], table: "", multiAccount: false, multiCompartment: false };
}

export const GormMessageOptions: MessageFns<GormMessageOptions> = {
  encode(message: GormMessageOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ormable !== false) {
      writer.uint32(8).bool(message.ormable);
    }
    for (const v of message.include) {
      ExtraField.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.table !== "") {
      writer.uint32(26).string(message.table);
    }
    if (message.multiAccount !== false) {
      writer.uint32(32).bool(message.multiAccount);
    }
    if (message.multiCompartment !== false) {
      writer.uint32(40).bool(message.multiCompartment);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GormMessageOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GormMessageOptions {
    return {
      ...
      multiCompartment: isSet(object.multiCompartment) ? globalThis.Boolean(object.multiCompartment) : false,
    };
  },
  ...
  toJSON(message: GormMessageOptions): unknown {
    ...
    if (message.multiCompartment !== false) {
      obj.multiCompartment = message.multiCompartment;
    }
    return obj;
  },

  create(base?: DeepPartial<GormMessageOptions>): GormMessageOptions {
    return GormMessageOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GormMessageOptions>): GormMessageOptions {
    const message = createBaseGormMessageOptions();
    ...
    message.multiCompartment = object.multiCompartment ?? false;
    return message;
  },
};
...
export const ExtraField: MessageFns<ExtraField> = {
  encode(message: ExtraField, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== "") {
    ...
    if (message.tag !== undefined) {
      GormTag.encode(message.tag, writer.uint32(26).fork()).join();
    }
    if (message.package !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExtraField {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<ExtraField>): ExtraField {
    return ExtraField.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ExtraField>): ExtraField {
    const message = createBaseExtraField();
...
export const GormFieldOptions: MessageFns<GormFieldOptions> = {
  encode(message: GormFieldOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tag !== undefined) {
      GormTag.encode(message.tag, writer.uint32(10).fork()).join();
    }
    if (message.drop !== false) {
      writer.uint32(16).bool(message.drop);
    }
    if (message.hasOne !== undefined) {
      HasOneOptions.encode(message.hasOne, writer.uint32(26).fork()).join();
    }
    if (message.belongsTo !== undefined) {
      BelongsToOptions.encode(message.belongsTo, writer.uint32(34).fork()).join();
    }
    if (message.hasMany !== undefined) {
      HasManyOptions.encode(message.hasMany, writer.uint32(42).fork()).join();
    }
    if (message.manyToMany !== undefined) {
      ManyToManyOptions.encode(message.manyToMany, writer.uint32(50).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GormFieldOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<GormFieldOptions>): GormFieldOptions {
    return GormFieldOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GormFieldOptions>): GormFieldOptions {
    const message = createBaseGormFieldOptions();
    message.tag = (object.tag !== undefined && object.tag !== null) ? GormTag.fromPartial(object.tag) : undefined;
...
export const GormTag: MessageFns<GormTag> = {
  encode(message: GormTag, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.column !== "") {
    ...
    if (message.disableAssociationAutoupdate !== false) {
      writer.uint32(160).bool(message.disableAssociationAutoupdate);
    }
    if (message.disableAssociationAutocreate !== false) {
      writer.uint32(168).bool(message.disableAssociationAutocreate);
    }
    if (message.associationSaveReference !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GormTag {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<GormTag>): GormTag {
    return GormTag.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GormTag>): GormTag {
    const message = createBaseGormTag();
...
export const HasOneOptions: MessageFns<HasOneOptions> = {
  encode(message: HasOneOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.foreignkey !== "") {
      writer.uint32(10).string(message.foreignkey);
    }
    if (message.foreignkeyTag !== undefined) {
      GormTag.encode(message.foreignkeyTag, writer.uint32(18).fork()).join();
    }
    if (message.associationForeignkey !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HasOneOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<HasOneOptions>): HasOneOptions {
    return HasOneOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HasOneOptions>): HasOneOptions {
    const message = createBaseHasOneOptions();
    message.foreignkey = object.foreignkey ?? "";
...
export const BelongsToOptions: MessageFns<BelongsToOptions> = {
  encode(message: BelongsToOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.foreignkey !== "") {
      writer.uint32(10).string(message.foreignkey);
    }
    if (message.foreignkeyTag !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BelongsToOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<BelongsToOptions>): BelongsToOptions {
    return BelongsToOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BelongsToOptions>): BelongsToOptions {
    const message = createBaseBelongsToOptions();
    message.foreignkey = object.foreignkey ?? "";
    message.foreignkeyTag = (object.foreignkeyTag !== undefined && object.foreignkeyTag !== null)
      ? GormTag.fromPartial(object.foreignkeyTag)
...
export const HasManyOptions: MessageFns<HasManyOptions> = {
  encode(message: HasManyOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.foreignkey !== "") {
      writer.uint32(10).string(message.foreignkey);
    }
    if (message.foreignkeyTag !== undefined) {
    ...
    if (message.positionFieldTag !== undefined) {
      GormTag.encode(message.positionFieldTag, writer.uint32(42).fork()).join();
    }
    if (message.disableAssociationAutoupdate !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HasManyOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<HasManyOptions>): HasManyOptions {
    return HasManyOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HasManyOptions>): HasManyOptions {
    const message = createBaseHasManyOptions();
    message.foreignkey = object.foreignkey ?? "";
    message.foreignkeyTag = (object.foreignkeyTag !== undefined && object.foreignkeyTag !== null)
      ? GormTag.fromPartial(object.foreignkeyTag)
...
export const ManyToManyOptions: MessageFns<ManyToManyOptions> = {
  encode(message: ManyToManyOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ManyToManyOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<ManyToManyOptions>): ManyToManyOptions {
    return ManyToManyOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ManyToManyOptions>): ManyToManyOptions {
    const message = createBaseManyToManyOptions();
...
export const AutoServerOptions: MessageFns<AutoServerOptions> = {
  encode(message: AutoServerOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.autogen !== false) {
      writer.uint32(8).bool(message.autogen);
    }
    if (message.txnMiddleware !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AutoServerOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<AutoServerOptions>): AutoServerOptions {
    return AutoServerOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AutoServerOptions>): AutoServerOptions {
    const message = createBaseAutoServerOptions();
