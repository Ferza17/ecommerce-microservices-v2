...
export const CartServiceService = {
  createCartItem: {
    path: "/proto.CartService/CreateCartItem",
    requestStream: false,
  ...
  findCartItemById: {
    path: "/proto.CartService/FindCartItemById",
    requestStream: false,
    responseStream: false,
  ...
  findCartItemsWithPagination: {
    path: "/proto.CartService/FindCartItemsWithPagination",
    requestStream: false,
    responseStream: false,
  ...
  updateCartItemById: {
    path: "/proto.CartService/UpdateCartItemById",
    requestStream: false,
    responseStream: false,
  ...
  deleteCartItemById: {
    path: "/proto.CartService/DeleteCartItemById",
    requestStream: false,
    responseStream: false,
...
export const CartServiceClient = makeGenericClientConstructor(CartServiceService, "proto.CartService") as unknown as {
