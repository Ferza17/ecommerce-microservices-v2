...
var ProductRpcService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ProductRpcService = void 0;
...
let ProductRpcService = ProductRpcService_1 = class ProductRpcService {
    client;
    otel;
    logger = new common_1.Logger(ProductRpcService_1.name);
    productService;
    ...
    async findProductById(requestId, req, context) {
        ...
        try {
            ...
            const cb = new opossum_1.default(breakerFn, circuitOptions_1.ProductServiceCircuitOptions);
...
exports.ProductRpcService = ProductRpcService;
exports.ProductRpcService = ProductRpcService = ProductRpcService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(service_1.Service.ProductService.toString())),
    __metadata("design:paramtypes", [Object, jaeger_telemetry_service_1.JaegerTelemetryService])
], ProductRpcService);
//# sourceMappingURL=product.rpc.service.js.map