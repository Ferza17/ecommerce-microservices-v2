...
func ProvideRabbitMQServer() *Server {
	...
	iAuthUseCase := usecase2.NewAuthUseCase(iUserPostgresqlRepository, iAuthRedisRepository, iRabbitMQInfrastructure, iTelemetryInfrastructure, postgresSQL, iZapLogger)
