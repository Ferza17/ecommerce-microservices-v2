...
func ProvideGrpcServer() *Server {
	...
	iAuthUseCase := usecase.NewAuthUseCase(iUserPostgresqlRepository, iAuthRedisRepository, iRabbitMQInfrastructure, iTelemetryInfrastructure, postgresSQL, iZapLogger)
