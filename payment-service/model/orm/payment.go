...
type Payment struct {
	...
	CreatedAt  time.Time          `gorm:"not null;autoCreateTime"`                                              // Auto-filled timestamp for creation time
	UpdatedAt  time.Time          `gorm:"not null;autoUpdateTime"`                                              // Auto-filled timestamp for last update time
}
