...
const file_notification_v1_notificationMessage_proto_rawDesc = "" +
	"\n" +
	")notification/v1/notificationMessage.proto\x12\x0fnotification_v1\x1a\x1cgoogle/protobuf/struct.proto\"\x93\x01\n" +
	"\x14NotificationTemplate\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x1a\n" +
	"\btemplate\x18\x03 \x01(\tR\btemplate\x12;\n" +
	"\ftemplateVars\x18\x04 \x01(\v2\x17.google.protobuf.StructR\ftemplateVars\"\x9c\x01\n" +
	"\x1fSendOtpEmailNotificationRequest\x12\x10\n" +
	"\x03otp\x18\x01 \x01(\tR\x03otp\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12Q\n" +
	"\x10notificationType\x18\x03 \x01(\x0e2%.notification_v1.NotificationTypeEnumR\x10notificationType*7\n" +
	"\x14NotificationTypeEnum\x12\x1f\n" +
	"\x1bNOTIFICATION_EMAIL_USER_OTP\x10\x00b\x06proto3"

var (
	file_notification_v1_notificationMessage_proto_rawDescOnce sync.Once
	file_notification_v1_notificationMessage_proto_rawDescData []byte
)
...
func file_notification_v1_notificationMessage_proto_rawDescGZIP() []byte {
	file_notification_v1_notificationMessage_proto_rawDescOnce.Do(func() {
		file_notification_v1_notificationMessage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_notification_v1_notificationMessage_proto_rawDesc), len(file_notification_v1_notificationMessage_proto_rawDesc)))
	})
...
var file_notification_v1_notificationMessage_proto_goTypes = []any{
...
func file_notification_v1_notificationMessage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_notification_v1_notificationMessage_proto_rawDesc), len(file_notification_v1_notificationMessage_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
