...
func (m *AuthUserRegisterRequest) validate(all bool) error {
	...
	if _, ok := _AuthUserRegisterRequest_Role_InLookup[m.GetRole()]; !ok {
		err := AuthUserRegisterRequestValidationError{
			field:  "Role",
			reason: "value must be in list [CUSTOMER CUSTOMER_MEMBERSHIP ADMIN SUPER_ADMIN]",
		}
		if !all {
			return err
		}
...
var _AuthUserRegisterRequest_Role_InLookup = map[EnumRole]struct{}{
	0:    {},
	1:    {},
	5505: {},
	5506: {},
...
// Validate checks the field values on FindUserByEmailRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *FindUserByEmailRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on FindUserByEmailRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// FindUserByEmailRequestMultiError, or nil if none found.
func (m *FindUserByEmailRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *FindUserByEmailRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if err := m._validateEmail(m.GetEmail()); err != nil {
		err = FindUserByEmailRequestValidationError{
			field:  "Email",
			reason: "value must be a valid email address",
			cause:  err,
		}
	...
	if len(errors) > 0 {
		return FindUserByEmailRequestMultiError(errors)
	}

	return nil
}

func (m *FindUserByEmailRequest) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *FindUserByEmailRequest) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
...
// FindUserByEmailRequestMultiError is an error wrapping multiple validation
// errors returned by FindUserByEmailRequest.ValidateAll() if the designated
// constraints aren't met.
type FindUserByEmailRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m FindUserByEmailRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m FindUserByEmailRequestMultiError) AllErrors() []error { return m }

// FindUserByEmailRequestValidationError is the validation error returned by
// FindUserByEmailRequest.Validate if the designated constraints aren't met.
type FindUserByEmailRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FindUserByEmailRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FindUserByEmailRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FindUserByEmailRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FindUserByEmailRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FindUserByEmailRequestValidationError) ErrorName() string {
	return "FindUserByEmailRequestValidationError"
}

// Error satisfies the builtin error interface
func (e FindUserByEmailRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sFindUserByEmailRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = FindUserByEmailRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = FindUserByEmailRequestValidationError{}
