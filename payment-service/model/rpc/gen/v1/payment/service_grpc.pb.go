...
func (c *paymentServiceClient) FindPaymentByUserIdAndStatus(ctx context.Context, in *FindPaymentByUserIdAndStatusRequest, opts ...grpc.CallOption) (*Payment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payment)
	err := c.cc.Invoke(ctx, PaymentService_FindPaymentByUserIdAndStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PaymentService_FindPaymentById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_FindPaymentById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PaymentService_FindPaymentByUserIdAndStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_FindPaymentByUserIdAndStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "v1/payment/service.proto",
}

const (
	PaymentProviderService_FindPaymentProviders_FullMethodName    = "/payment.PaymentProviderService/FindPaymentProviders"
	PaymentProviderService_FindPaymentProviderById_FullMethodName = "/payment.PaymentProviderService/FindPaymentProviderById"
)
...
func (c *paymentProviderServiceClient) FindPaymentProviders(ctx context.Context, in *FindPaymentProvidersRequest, opts ...grpc.CallOption) (*FindPaymentProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, PaymentProviderService_FindPaymentProviders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterPaymentProviderServiceServer(s grpc.ServiceRegistrar, srv PaymentProviderServiceServer) {
	// If the following call pancis, it indicates UnimplementedPaymentProviderServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _PaymentProviderService_FindPaymentProviders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentProviderService_FindPaymentProviders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PaymentProviderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "payment.PaymentProviderService",
