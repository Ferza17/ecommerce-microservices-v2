...
func (c *paymentConsumer) PaymentOrderDelayedCancelled(ctx context.Context, d *amqp091.Delivery) error {
	ctx, span := c.telemetryInfrastructure.StartSpanFromContext(ctx, "PaymentConsumer.PaymentOrderDelayedCancelled")
